    ...
    public static void inputContactsHorisontalFormat(String fileName, PhoneBook phoneBook) {
        try (BufferedReader br = new BufferedReader(new FileReader(fileName))) {
            ...
            while (line != null) {
                ...
                phoneBook.getAllContacts().add(ContactBuilder.Create()
                        .setName(contact[0])
                        .setSurname(contact[1])
                        .setPhoneNumber(Long.parseLong(contact[2]))
                        .build());
                line = br.readLine();
            }
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(fileName))) {
            ...
            while (line != null) {
                ...
                if (contact.toArray().length == 3) {
                    phoneBook.getAllContacts().add(ContactBuilder.Create()
                            .setName(contact.get(0))
                            .setSurname(contact.get(1))
                            .setPhoneNumber(Long.parseLong(contact.get(2)))
                            .build());
