    ...
    public static void start(PhoneBook phoneBook) throws IOException {
        switch (Interface.mainMenu()) {
            case 1:
                ...
                phoneBook.addContact(ContactBuilder.Create()
                        .setName(Interface.inputName())
                        .setSurname(Interface.inputSurname())
                        .setPhoneNumber(Interface.inputPhoneNumber())
                        .build());
            ...
            case 3:
                ...
                start(phoneBook);
            case 4:
                Contact con = ContactBuilder.Create()
                        .setName(Interface.inputName())
                        .setSurname(Interface.inputSurname())
                        .setPhoneNumber(Interface.inputPhoneNumber())
                        .build();
